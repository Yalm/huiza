...
<td valign="top" class="em_aside">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td valign="middle" align="center"><h1 style="display:block; font-family: 'Indie Flower', cursive; letter-spacing:6px; font-size:45px; line-height:42px; color:#feae39;max-width:398px;">¡Nuevo pedido!</h1></td>
		</tr>
		<tr>
		...
		@if($order->state_id != 2)				  
			<tr>
				<td height="1" bgcolor="#d6d7d8" style="font-size:0px;line-height:0px;">
                <img src="https://www.sendwithus.com/assets/img/emailmonks/images/spacer.gif" width="1"
                 height="1" alt="" style="display:block;" border="0" /></td>
			</tr>
			<tr>
				<td height="27" class="em_height">&nbsp;</td>
			</tr>
			<tr>
				<td valign="top" align="left" style="font-family:'Open Sans', Arial, sans-serif; 
                font-size:17px;line-height:22px; 
                color:#BED001;">El pedido esta a la espera que confirmes que el pago se ha 
                recibido. Los detalles del pedido se muestran abajo como referencia</td>
			</tr>
			<tr>
		...
		@else
			...
			<tr>
				<td valign="top" align="left" style="font-family:'Open Sans', Arial, sans-serif; 
                font-size:17px;line-height:22px; 
                color:#BED001;">El pago del pedido esta confirmado. Los detalles del pedido se muestran abajo como referencia</td>
			</tr>
			<tr>
				<td height="23" class="em_height">&nbsp;</td>
			</tr>
		@endif
						...
						<tr>
							...
							<td valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td align="left" valign="top"  class="em_font1" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:20px; font-weight:bold; color:#BED001; text-transform:uppercase;">MÉTODO DE PAGO : &nbsp;<span style=" color:#FFF;">{{ $order->state_id == 2 ? 'TARJETA DE CREDITO':'TRANSFERENCIA BANCARIA DIRECTA'}}</span></td>
									</tr>
			...
			<tr>
				<td valign="top">
						...
						<tr>
							...
							<td valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td align="left" valign="top"  class="em_font1" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; line-height:20px; font-weight:bold; color:#BED001; text-transform:uppercase;">CLIENTE: &nbsp;<span style=" color:#FFF;">{{ $order->customer->name.' '.$order->customer->surnames }}</span></td>
									</tr>
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px; color:#fff;">Siéntase libre de revisar el pedido a continuación o haga clic en el boton ver el pedido
                    </td>
                  </tr>
                  <tr>
                    <td height="12" style="font-size:1px; line-height:1px;">&nbsp;</td>

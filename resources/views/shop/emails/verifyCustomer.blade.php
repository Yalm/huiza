                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr style="text-align: center;">
                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                <h1 style="margin: 0 0 10px; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;">Bienvenido,estamos encatados de que se haya unido a nosotros.</h1>
                                <p style="margin: 0 0 10px;">Tendras que hacer click en el boton de confirmar correo que aparece en este mensaje para activar su cuenta.</p>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                                    <tr>
                                        <td class="button-td button-td-primary" style="border-radius: 4px; background: #000;">
											<a class="button-a button-a-primary" href="{{url('customer/verify', $customer->verifyCustomer->token)}}" style="background: #000; border: 1px solid #d5d5d5; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #fff; display: block; border-radius: 2px;">CONFIRMAR CORREO</a>
										</td>
                                    </tr>
                                </table>
                                <!-- Button : END -->
